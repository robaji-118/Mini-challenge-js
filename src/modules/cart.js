...
// Fungsi baru: Kurangi jumlah produk dari keranjang
...
const updateCartUI = () => {
 ...
 cart.forEach((item) => {
  ...
  // Ubah HTML untuk menampilkan gambar, ukuran, dan tombol tambah/kurang
...
export const setupCartListeners = () => {
 ...
 // ... (Sisa kode listeners lainnya tetap sama)
};